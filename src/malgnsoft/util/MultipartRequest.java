...
import malgnsoft.util.multipart.MultipartParser;
import malgnsoft.util.multipart.Part;
import malgnsoft.util.multipart.FilePart;
import malgnsoft.util.multipart.ParamPart;
import malgnsoft.util.multipart.FileRenamePolicy;
import malgnsoft.util.multipart.DefaultFileRenamePolicy;
...
public class MultipartRequest {
  ...
  public MultipartRequest(HttpServletRequest request,
                          ...
                          int maxPostSize,
                          String encoding) throws IOException {
    this(request, saveDirectory, maxPostSize, encoding, new DefaultFileRenamePolicy());
  }
  ...
  public MultipartRequest(HttpServletRequest request,
    ...
    if (request.getQueryString() != null) {
      ...
      while (queryParameterNames.hasMoreElements()) {
        String paramName = (String)queryParameterNames.nextElement();
